...
def bug_document(
    *,
    ...
    metadata = {
        ...
        "refs": {
            "task": pointer(task_path, section="s-acceptance", artifact_id=task_id, relation="informs", tags=("task", "criteria"))
        },
        "search_contract": [
            {
...
def code_document(
    *,
    ...
    metadata = {
        ...
        "refs": {
            "task": pointer(task_path, section="s-objective", artifact_id=task_id, relation="implements", tags=("task", "implementation"))
        },
        "search_contract": [
            {
