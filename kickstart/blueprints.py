...
def _source_blueprint(
    ...
    *,
    ...
    sections = [
        ...
        {"id": "s-validation", "title": "VALIDATION", "capsule": "Raw and logical hashes are recomputable from the live source.", "content": f"- Raw SHA-256: `{facts['sha256'].upper()}`\n- Logical-line SHA-256: `{facts['logical_sha256'].upper()}`\n- Bytes: `{facts['byte_count']}`\n- Lines: `{len(source_lines)}`"},
...
def _header_blueprint(
    ...
    *,
    ...
    sections = [
        ...
        {"id": "s-validation", "title": "VALIDATION", "capsule": "Raw and logical hashes are recomputable from the live header.", "content": f"- Raw SHA-256: `{facts['sha256'].upper()}`\n- Logical-line SHA-256: `{facts['logical_sha256'].upper()}`\n- Bytes: `{facts['byte_count']}`\n- Lines: `{len(header_lines)}`"},
